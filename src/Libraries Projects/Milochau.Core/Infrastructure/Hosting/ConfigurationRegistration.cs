...
namespace Milochau.Core.Infrastructure.Hosting
{
    ...
    ///    <item>JSON file appsettings.local.json (only if host is local)</item>
    /// </list>
    /// </remarks>
    public static class ConfigurationRegistration
    {
        ...
        public static void AddApplicationConfiguration(IConfiguration hostingContextConfiguration, IConfigurationBuilder configurationBuilder)
        {
            ...
            {
                internalConfigurationBuilder.AddAzureAppConfiguration(appConfigOptions => AppConfigurationRegistration.ConfigureAzureAppConfiguration(appConfigOptions, hostOptions));
            }
